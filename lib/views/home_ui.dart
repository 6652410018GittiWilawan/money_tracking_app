...
import 'package:money_tracking_app/views/sub_home01_screen.dart';
import 'package:money_tracking_app/views/sub_home02_screen.dart';
import 'package:money_tracking_app/views/sub_home03_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Theme(
        data: Theme.of(context).copyWith(canvasColor: Colors.brown),
